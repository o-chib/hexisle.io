...
export default class UIScene extends Phaser.Scene {
	...
	create(): void {
        this.helpButtonSprite = this.add.sprite(0,0,'help_button_unpressed').setDepth(1000);
        ...
        this.helpPopupSprite = this.add.sprite(0,0,'help_popup').setDepth(1000).setVisible(false);
